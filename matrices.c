...
void sumatriz(int fila, int columna, int matrizA[fila][columna], int matrizB[fila][columna], int suma[fila][columna])
{ //  creamos la funcion sumatriz la cuan incluyen todas las matrices A-B-suma y fila- columna
...
int main()
{
    ...
    for (i = 0; i < fila; i++)
    {
        for (j = 0; j < columna; j++)
        {
            printf("%d ", matrizA[i][j]); // imprime la matriz A
        }
        printf("\n");
    }
    ...
    for (i = 0; i < fila; i++)
    {
        for (j = 0; j < columna; j++)
        {
            printf("%d ", matrizB[i][j]); // imprime la matriz B
        }
        printf("\n");
    }
